...
export const uploadMarks = async (req, res) => {
  try {
    const { department, year, section, test, marks, externalMarks, practicalMarks, gredePoint, sem, student } = req.body;
   
    console.log(student);
    const errors = { examError: String };
    const existingTest = await Student.findOne({
      _id: student
    });
